...
<div id="sliderhome" class="container">
	<div id="layerslider" class="ls-wp-container ls-container ls-fullwidth" style="height: 300px; margin: 0px auto; width:100%;">
		<div class="ls-slide" data-ls="slidedelay:8000;transition2d:75,79;">
			...
			<img src="http://placehold.it/1170x300" class="ls-bg" alt="Slide background"/>
		...
		<div class="ls-slide" data-ls="slidedelay:9500;transition2d:5;timeshift:-3000;">
			...
			<a href="/matches.html" target="_blank" class="ls-l button-medium" data-ls="offsetxin:0;offsetyin:300px;durationin:2000;delayin:700;offsetxout:-50;durationout:1000;"  style=" top: 216px; left: 35px; display: block; opacity: 1;  margin-left: 0px; margin-top: 0px; ">
				Check out the matches page! 
				</a>
			</div>
			<div class="ls-slide" data-ls="slidedelay:9500;transition2d:5;timeshift:-3000;">
				<img src="http://placehold.it/1170x300" class="ls-bg" alt="Slide background" style="padding: 0px; border-width: 0px; width: 1170px; height: 301px; margin-left: -585px; margin-top: -150.5px; visibility: visible; opacity: 1;">
				...
				<img class="ls-s-1" data-ls="offsetxin:0;offsetyin:300px;durationin:2000;delayin:1200;offsetxout:-50;durationout:1000;"  src="http://placehold.it/305x305" style="position: absolute; top: 40px; left: 595px; width: 342px; height: 268px; padding: 0px; border-width: 0px; opacity: 1; -webkit-transform: rotate(0deg) scale(1, 1); margin-left: 0px; margin-top: 0px; display: block; visibility: hidden;">
				<img class="ls-s-1" data-ls="offsetxin:0;offsetyin:0px;durationin:2000;delayin:4000;offsetxout:-50;durationout:1000;"  src="http://placehold.it/305x305" style="position: absolute; top: 40px; left: 596px; width: 342px; height: 268px; padding: 0px; border-width: 0px; -webkit-transform: rotate(0deg) scale(1, 1); opacity: 1; visibility: hidden; margin-left: 0px; margin-top: 0px;">
			</div>

			<div class="ls-slide" data-ls="slidedelay:9500;transition2d:5,6,2,3;timeshift:-3000;">
				<img src="http://placehold.it/1170x300" class="ls-bg" alt="Slide background" style="padding: 0px; border-width: 0px; width: 1170px; height: 301px; margin-left: -585px; margin-top: -150.5px; visibility: visible;">
				<img class="ls-s-1" src="http://placehold.it/305x305" data-ls="offsetxin:-300;offsetyin:0px;durationin:2000;delayin:2000;offsetxout:-50;durationout:1000;" style="position: absolute; top: 0px; left: 0px; width: 543px; height: 301px; padding: 0px; border-width: 0px; opacity: 1; -webkit-transform: rotate(0deg) scale(1, 1); margin-left: 0px; margin-top: 0px; display: block; visibility: visible;">
				<img class="ls-s-1" src="http://placehold.it/305x305" data-ls="offsetxin:-300;offsetyin:0px;durationin:2000;delayin:4000;offsetxout:-50;durationout:1000;" style="position: absolute; top: 0px; left: 0px; width: 535px; height: 301px; padding: 0px; border-width: 0px; opacity: 1; -webkit-transform: rotate(0deg) scale(1, 1); margin-left: 0px; margin-top: 0px; display: block; visibility: visible;">
				...
				<div class="span12">
					<div class="template-wrapper">
						<ul id="js-news" class="js-hidden">
                                <li class="news-item">You can add a <a href="#">link</a> too if you want!</li>
                                <li class="news-item">Check out this awesome ticker! Add any text you want!</li>
                                <li class="news-item">Breaking news: Game Addict wins against Fnatic, <a href="#">check the video here!</a></li>
                        </ul>
						<div class="clear"></div>
					</div>
					<div class="clear"></div>
...
?>		
						...
						<?php include("../themes/crak/_right_sidebar.php"); ?>

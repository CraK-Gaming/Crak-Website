...
<footer class="container">
			...
			<div class="copyright span12">
				<p>© &nbsp;CrakGaming. All Rights Reserved&nbsp;</p>
				<div class="social">
		...
		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/js/jquery.js"></script>
		<!-- JavaScript -->

		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/js/jquery-migrate.min.js"></script>
		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/js/jquery.fancybox.js"></script>
		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/js/jquery.elastic.source.js"></script>
		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/js/jquery.carouFredSel-6.2.1-packed.js"></script>
		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/js/jquery-ui-1.10.3.custom.min.js"></script>
		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/js/jquery.ui.totop.js"></script>
		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/js/login-with-ajax.js"></script>
		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/js/bootstrap-button.js"></script>
		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/js/bootstrap-carousel.js"></script>
		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/js/bootstrap-collapse.js"></script>
		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/js/bootstrap-modal.js"></script>
		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/js/bootstrap-tab.js"></script>
		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/js/bootstrap-tooltip.js"></script>
		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/js/bootstrap-transition.js"></script>
		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/js/bootstrap-popover.js"></script>
		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/js/appear.js"></script>
		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/js/easing.js"></script>
		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/js/global.js"></script>
		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/js/imagescale.js"></script>
		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/js/isotope.js"></script>
		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/js/login-with-ajax.source.js"></script>
		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/js/main.js"></script>
		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/js/parallax.js"></script>
		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/js/theme.min.js"></script>
		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/js/tinymce.min.js"></script>
		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/js/transit.js"></script>
		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/js/admin.js"></script>
		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/layerslider/js/greensock.js"></script>
		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/layerslider/js/layerslider.transitions.js"></script>
		<script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/layerslider/js/layerslider.kreaturamedia.jquery.js"></script>
	    <script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/isotope_gallery/js/rx_isotope_gallery.js"></script>
        <script type="text/javascript" src="<?php echo $MAIN_ROOT; ?>/themes/crak/lib/isotope_gallery/com/riaextended/js/tween/TweenMax.min.js"></script>
